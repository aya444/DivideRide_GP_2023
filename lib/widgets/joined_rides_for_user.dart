...
class JoinedRidesForUser extends StatefulWidget {
  const JoinedRidesForUser({Key? key}) : super(key: key);

  @override
  State<JoinedRidesForUser> createState() => _JoinedRidesForUserState();
}

class _JoinedRidesForUserState extends State<JoinedRidesForUser> {
