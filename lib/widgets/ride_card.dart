...
//     return InkWell(
//       onTap: () {
//         Get.to(()=> RideDetailsView(widget.ride,driver));
//       },
//       child: Container(
//         width: double.maxFinite,
//         height: 215,
...
//               ),
//               title: Text(
//                 '${driver.get('name')}', //widget.DriverDoc!.get('driver_name') ,
...
//                                       width: double.maxFinite,
//                                       child: Text(
//                                         "From:  New Cairooooooooooooo sho ii",
//                                         style: TextStyle(
//                                           fontSize: 13,
//                                           fontWeight: FontWeight.w600,
//                                           //   color: AppColors.black,
...
//                                       width: double.maxFinite,
//                                       child: Text(
//                                         "To:  Shobra, Menyat as Serg, El Sahel sh",
//                                         style: TextStyle(
//                                           fontSize: 13,
//                                           fontWeight: FontWeight.w600,
//                                           //color: AppColors.black,
